...
<div class="row">
	<div class="col-12">
        <div class="card" style="border-radius: 12px; background: #A1EAFB;">
            <div class="card-body">
...
<div class="row">
    <div class="col-12">
        <div class="card card-body" style="border-radius: 12px; background: #A1EAFB;">
                    ...
                    <div class="tab-pane show active" id="dingdanhao">
                        <form class="needs-validation" action="{{ url('search-order-by-sn') }}" method="post">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" name="order_sn"  style="border-radius: 24px; width: auto;" required  placeholder="{{ __('hyper.searchOrder_input_order_number') }}">
                            </div>
                            <div class="form-group mb-3">
                                {{-- 立即查询 --}}
                                <button class="btn btn-primary" type="submit" style="border-radius: 24px;">{{ __('hyper.searchOrder_search_now') }}</button>
                                {{-- 重置 --}}
                                <button type="reset" class="btn btn-primary" style="border-radius: 24px;">{{ __('hyper.searchOrder_reset_order') }}</button>
                            </div>
                        </form>
                    </div>
                    <div class="tab-pane" id="youxiang">
                        <form class="needs-validation" action="{{ url('search-order-by-email') }}" method="post">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" name="email"  style="border-radius: 24px; width: auto;" required  placeholder="根据你下单的格式填写">
                               @else
