...
@section('content')
<div class="row mt-3">
    <!-- 左侧三个卡片作为一个整体，使用 col-12 col-md-9 来控制宽度 -->
    <div class="col-12 col-md-9">
        <div class="row">
            <!-- 第一张卡片 -->
            <div class="col-sm" style="min-width: 269px;">
                <div class="card stats-card" style="background: #A1EAFB; border-radius: 24px;">
                    <div class="stats-detail">
                        <span><i class="uil uil-user-plus" style="font-size: 14px; vertical-align: left;"></i>返利订单数</span>
            ...
            <div class="col-sm" style="min-width: 269px;">
                <div class="card stats-card" style="background: #A1EAFB; border-radius: 24px;">
                    <div class="stats-detail">
                        <span><i class="uil uil-card-atm" style="font-size: 14px; vertical-align: left;"></i>可提现金额</span>
                        <div class="stats-member">
                            <h6 class="h6 mt-0" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 88px;" data-toggle="tooltip" data-placement="top" title="{{ Auth::user()->email }}">
                                {{ $invite_amount }}
                            </h6>
                    ...
                    <button class="btn btn-sm btn-warning btn-pill" 
                            style="font-size: 12px; color: #fff; background: #fdb933; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; border-radius: 24px;" 
                            data-toggle="modal" 
                            data-target="#withdrowalModal">
                        提现
                    </button>
                </div>
            </div>
            ...
            <div class="col-sm" style="min-width: 269px;">
                <div class="card stats-card" style="background: #A1EAFB; border-radius: 24px;">
                    <div class="stats-detail">
                        <span><i class="uil uil-card-atm" style="font-size: 14px; vertical-align: left;"></i>邀请链接</span>
                        <div class="stats-member">
                            <h6 class="h6 mt-0"
                                style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 122px; direction: rtl; text-align: left;" 
                                data-toggle="tooltip" data-placement="top" title="{{ Auth::user()->email }}">
                                {{ config('app.url') }}?aff={{ Auth::user()->invite_code }}
                            </h6>
                        </div>
                    </div>
                    <button class="btn btn-sm btn-warning btn-pill"
    ...
    <!-- 右侧返现公告作为单独的卡片，使用 col-12 col-md-3 来控制宽度 -->
    <div class="col-12 col-md-3">
        <div class="card" style="border-radius: 24px; background: #A1EAFB;">
            <h5 class="text-center" style="font-size: 21px; border-bottom: 1px solid white; padding-bottom: 10px; margin-bottom: 10px;">返现公告</h5>
...
<div class="row invite-card">
    <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-9">
        <div class="card" style="border-radius: 24px; background: #f6f5ec;">
            <div class="card" style="border-radius: 24px; background: #f6f5ec;">
                <div class="card-header" style="border-radius: 24px; background: #f6f5ec;">
    ...
    <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-3">
        <div class="card" style="border-radius: 24px; background: #A1EAFB;">
            <h5 class="text-center" style="font-size: 21px; border-bottom: 1px solid white; padding-bottom: 10px; margin-bottom: 10px;">返现规则</h5>
            <div class="card-body contact"><p>{!! dujiaoka_config_get('guize_text') !!}</p></div>
        </div>
    </div>
</div>
